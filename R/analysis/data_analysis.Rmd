...
The data now contains `r nrow(d)` observations. With the cleaning out of the way, let's now have a look to see whether the data supports our hypotheses.
